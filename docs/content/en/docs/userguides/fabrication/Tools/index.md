...
<div class="clearfix">
<img src="images/kapton.png#floatright" alt="kapton tape" width=30%>
...
<div class="clearfix">
<img src="images/ceramic.png#floatright" alt="ceramic tweezers" width=30%>
...
<div class="clearfix">
<img src="images/scissors.png#floatright" alt="scissors" width=30%>
...
<img src="images/stirrers.png#floatright" alt="coffee stirrers" width=30%>
...
<div class="clearfix">
<img src="images/cord.png#floatright" alt="elastic cord" width=30%>

**Harness Material (elastic cord)**  1mm (or smaller) 
elastic cord is needed for building harnesses.  See
[leg harness section](../../legharness/) for directions.
...
<div class="clearfix">
<img src="images/solderingstation.png#floatright" alt="soldering station" width=30%>
...
<div class="clearfix">
<img src="images/boommicroscope.png#floatright" alt="soldering station" width=30%>
...
<div class="clearfix">
<img src="images/optivisor.png#floatright" alt="optivisor" width=30%>
...
<div class="clearfix">
<img src="images/solder.png#floatright" alt="solder" width=30%>
...
<div class="clearfix">
<img src="images/flux.png#floatright" alt="flux" width=30%>

**Flux** in pen form is especially useful for soldering small components such as batteries.
</div>

<div class="clearfix">
<img src="images/fluxremover.png#floatright" alt="flux remover" width=30%>

** Flux Remover** After soldering, all components should be carefully cleaned with flux remover. 

</div>

<div  class="clearfix"><img  src="images/cottonswabs.png#floatright"  alt="cotton swabs"  width=30%> 
...
<div  class="clearfix"><img  src="images/maskingtape.png#floatright"  alt="Masking Tape"  width=30%>
...
<div  class="clearfix"><img  src="images/floralwire.png#floatright"  alt="FLoral Wire"  width=15%>
...
<div  class="clearfix"><img  src="images/xacto.png#floatright"  alt="xacto knife"  width=30%>
...
<div  class="clearfix"><img  src="images/pinvise.png#floatright"  alt="pin vise"  width=30%>

**Pin Vise**  A pin vise with 1-1.1 mm drill is needed for cleaning the tag holes after coating
</div>

<div  class="clearfix"><img  src="images/dykes.png#floatright"  alt="diagonal cutters"  width=30%>
...
<div  class="clearfix"><img  src="images/coating.png#floatright"  alt="Urethane Coating"  width=20%>
...
<div  class="clearfix"><img  src="images/magneticfixture.png#floatright"  alt="Magnetic Fixture"  width=30%>
